 ...
 */
package org.opendaylight.controller.peregrine.cli.commands;
 ...
 */
@Command(name = "test-cli", scope = "peregrine",
        description = "add a description for the command")
public class PeregrineCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(PeregrineCliTestCommand.class);
    protected final PeregrineCliCommands service;

    public PeregrineCliTestCommand(final PeregrineCliCommands service) {
