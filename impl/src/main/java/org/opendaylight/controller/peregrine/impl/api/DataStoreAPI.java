...
package org.opendaylight.controller.peregrine.impl.api;
 ...
 * @since 2014-11-22
 */
public final class DataStoreAPI {
    private static DataBroker dataProvider = null;
    private static final Logger LOG = LoggerFactory.getLogger(DataStoreAPI.class);
    ...
    public void setDataProvider(DataBroker broker) {
        dataProvider = broker;
        LOG.info("setDataProvider: DataStoreAPI initial...");
    }
